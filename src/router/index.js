...
const routes = [
  ...
  { path: '/online-courses/:id', component: () => import('../pages/OnlineCourseDetail.vue') },
  { path: '/online-courses/:id/live', component: () => import('../pages/LiveClass.vue'), meta: { requiresAuth: true } },
